        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="sm:text-center md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
            <div className="lg:py-12">
              ...
              <h1 className="heading-1 text-foreground animate-fade-in">
                <span className="block">Connect, Trade, Grow</span>
                <span className="block text-agri-primary">Smarter Farming</span>
              </h1>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 sm:gap-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="mt-8 pt-8 border-t border-border/60 grid grid-cols-3 gap-4 animate-fade-in" style={{ animationDelay: '0.6s' }}>
                <div>
          ...
          <div className="mt-12 sm:mt-16 lg:mt-0 lg:col-span-6 lg:flex lg:items-center animate-fade-in" style={{ animationDelay: '0.5s' }}>
            <div className="relative mx-auto w-full rounded-lg shadow-xl overflow-hidden lg:max-w-md">
              <div className="relative block w-full h-80 sm:h-96 lg:h-[30rem] bg-agri-primary rounded-lg overflow-hidden animate-bounce-slow">
                <img
                  src="https://images.unsplash.com/photo-1472396961693-142e6e269027?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80"
                  alt="Farm landscape"
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-tr from-agri-primary/70 to-transparent mix-blend-multiply" />
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="bg-white/90 dark:bg-card/90 backdrop-blur-sm rounded-lg p-4 shadow-lg">
